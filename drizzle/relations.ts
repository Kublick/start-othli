...
import { user, budget, sharedBudget, budgetCategory, categories, recurringTransaction, session, sharedBudgetMember, account, userSubscription, subscriptionSeat, userAccount, transaction, userInvitation } from "./schema";
...
export const sharedBudgetRelations = relations(sharedBudget, ({one, many}) => ({
	budgets: many(budget),
	recurringTransactions: many(recurringTransaction),
	user: one(user, {
...
export const sharedBudgetMemberRelations = relations(sharedBudgetMember, ({one}) => ({
	sharedBudget: one(sharedBudget, {
...
export const subscriptionSeatRelations = relations(subscriptionSeat, ({one}) => ({
